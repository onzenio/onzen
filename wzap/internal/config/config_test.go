...
func setRequiredEnv(t *testing.T) {
	...
	t.Setenv("WZAP_DATABASE_URL", "postgres://onefisc:secret@127.0.0.1:5432/onefisc_wzap")
...
func TestLoadFullConfig(t *testing.T) {
	...
	for key, value := range map[string]string{
		...
		"WZAP_DATABASE_URL":         "postgres://onefisc:secret@db:5432/onefisc_wzap",
	...
	want := Config{
		...
		ServiceToken:       "token",
		DatabaseURL:        "postgres://onefisc:secret@db:5432/onefisc_wzap",
...
func TestLoadDefaults(t *testing.T) {
	...
	want := Config{
		...
		PublicURL:          "",
		ServiceToken:       "token",
		DatabaseURL:        "postgres://onefisc:secret@127.0.0.1:5432/onefisc_wzap",
