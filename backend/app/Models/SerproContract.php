 ...
 */
#[Fillable(['environment', 'consumer_key_ref', 'consumer_secret_ref', 'transport_approved'])]
class SerproContract extends Model
{
    ...
    /**
     * @return array{environment: string, consumer_key_masked: string|null, consumer_secret_masked: string|null, transport_approved: bool}
     */
