...
class ExecuteSerproActionJob implements ShouldQueue
{
    ...
    public function __construct(
        public readonly int $monitoringRunId,
    ...
    {
        if (! $this->confirmed) {
            throw new RuntimeException('Ação fiscal exige confirmação explícita.');
        }
