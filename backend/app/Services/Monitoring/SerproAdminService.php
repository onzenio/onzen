...
class SerproAdminService
{
    ...
    public function replaceCredentials(User $actor, string $environment, array $payload): SerproContract
    {
        ...
        $this->audit->record($actor, 'platform.serpro_credentials_rotated', [
            'environment' => $environment,
    ...
    public function switchEnvironment(User $actor, string $environment, ?string $evidence = null): SerproSettings
    {
        ...
        $this->audit->record($actor, 'platform.serpro_environment_switched', [
            'before' => $previous,
            'after' => $environment,
            'evidence' => $evidence,
    ...
    {
        $this->audit->record($actor, 'platform.serpro_environment_switch_refused', [
    ...
    {
        $this->audit->record($actor, 'platform.serpro_transport_refused', [
            'enabled' => $enabled,
            'environment' => $this->gate->environment(),
            'reasons' => array_values($reasons),
        ], $this->platformAccount());
