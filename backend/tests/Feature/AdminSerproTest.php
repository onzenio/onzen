...
final class AdminSerproTest extends TestCase
{
    ...
    public function test_mutations_are_forbidden_for_everyone_but_account_a_super_admin(): void
    {
        ...
        // O observer de Audit registra os creates do setup (accounts/users);
        // mutações proibidas não SHALL gerar nenhum evento administrativo.
        $this->assertSame(0, AuditLog::query()->where('action', 'like', 'platform.serpro%')->count());
    }
